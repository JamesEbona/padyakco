          ...
          <div class="row">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                <a class="text-decoration-none" href="{{route('memberUsers')}}">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                <a class="text-decoration-none" href="{{route('adminOrders')}}">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                <a class="text-decoration-none" href="{{route('adminBookings')}}">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                <a class="text-decoration-none" href="{{route('inquiries')}}">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
