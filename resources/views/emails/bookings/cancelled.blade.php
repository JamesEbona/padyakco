                                  ...
                                  <table cellspacing="0" cellpadding="0" border="0" width="100%" role="presentation">
                                    <tr>
                                      <th style="mso-line-height-rule: exactly;" bgcolor="#ffffff" valign="top">
                                        <h1 data-key="3499733_heading" style="font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Roboto'; font-size: 24px; line-height: 36px; font-weight: 400; color: #1a1a1a; text-transform: none; margin: 0;">REPAIR BOOKING CANCELLED</h1>
                                      </th>
                                    </tr>
                                  </table>
                                </th>
                              ...
                              <tr id="section-3499735" class="section introduction">
                                <th style="mso-line-height-rule: exactly; padding: 11px 44px;" bgcolor="#ffffff">
                                  ...
                                  class="text" style="text-align: left; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Roboto'; font-size: 15px; line-height: 22px; font-weight: 400; text-transform: none; color: #000000;">
                                        ...
                                        <p style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Roboto'; font-size: 15px; line-height: 22px; font-weight: 400; text-transform: none; color: #000000; margin: 11px 0 0;" align="left">We are sorry to inform you that your booking has been cancelled due to an unforseen cirsumstance. Please try booking at a later time.</p>
                                      </span>
                                </th>
                              </tr>
