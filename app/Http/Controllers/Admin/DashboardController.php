...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.home', compact('member_count','pending_orders_count','pending_bookings_count','basic_count','expert_count','upgrade_count','inquiries_count','productCategories','store_month_sales','booking_month_sales','store_year_sales','booking_year_sales'));
    }
